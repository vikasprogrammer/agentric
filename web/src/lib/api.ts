...
export const api = {
  ...
  planGoal: (id: string, steer?: { guidance?: string; maxTasks?: number }) => call<{ ok: boolean; sessionId?: string; error?: string }>('POST', `/api/goals/${id}/plan`, steer ?? {}),
  ...
  agentConfig: (id: string) => call<{ agent: string; error?: string; description?: string; examplePrompts?: string[]; shellSecrets?: string[]; usableSubagents?: string[]; spawnableAsSubagent?: boolean; chatReachable?: boolean; netMode?: 'open' | 'allowlist'; category?: string; icon?: string } & RuntimeTuning>('GET', `/api/agents/${encodeURIComponent(id)}/config`),
  saveAgentConfig: (id: string, patch: RuntimeTuning & { description?: string; examplePrompts?: string[]; shellSecrets?: string[]; usableSubagents?: string[]; spawnableAsSubagent?: boolean; chatReachable?: boolean; netMode?: 'open' | 'allowlist'; category?: string; icon?: string }) => call<{ ok: boolean; error?: string; description?: string; examplePrompts?: string[]; shellSecrets?: string[]; usableSubagents?: string[]; spawnableAsSubagent?: boolean; chatReachable?: boolean; netMode?: 'open' | 'allowlist'; category?: string; icon?: string } & RuntimeTuning>('PUT', `/api/agents/${encodeURIComponent(id)}/config`, patch),
